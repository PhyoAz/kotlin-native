...
private inline fun <reified T : IrElement> T.deepCopyWithSymbols(initialParent: IrDeclarationParent? = null): T {
    ...
    when (irFunction) {
        ...
        is IrSimpleFunction -> {
            ...
            return IrFunctionImpl(
                ...
                name,
                irFunction.visibility,
                if (irFunction.modality === Modality.ABSTRACT) Modality.FINAL else irFunction.modality,
                irFunction.returnType,
                irFunction.isInline,
                false,
                false,
